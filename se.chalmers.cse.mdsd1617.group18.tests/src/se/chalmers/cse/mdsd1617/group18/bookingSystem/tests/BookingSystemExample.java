...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>bookingSystem</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BookingSystemExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(BookingSystemPackage.eNS_URI, 
			 BookingSystemPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.bookingsystem"));
				CheckInEvent root = BookingSystemFactory.eINSTANCE.createCheckInEvent();
