...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>roomManager</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RoomManagerExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(RoomManagerPackage.eNS_URI, 
			 RoomManagerPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.roommanager"));
				RoomType root = RoomManagerFactory.eINSTANCE.createRoomType();
