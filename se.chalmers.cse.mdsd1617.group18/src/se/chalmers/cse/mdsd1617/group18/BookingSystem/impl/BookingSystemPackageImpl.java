...
public class BookingSystemPackageImpl extends EPackageImpl implements BookingSystemPackage {
	 ...
	 * @generated
	 */
	public EOperation getAbstractEvent__GetType() {
		return abstractEventEClass.getEOperations().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(abstractEventEClass, ABSTRACT_EVENT___GET_TYPE);
	...
	public void initializePackageContents() {
		...
		initEOperation(getAbstractEvent__GetType(), this.getEventType(), "getType", 1, 1, IS_UNIQUE, !IS_ORDERED);
